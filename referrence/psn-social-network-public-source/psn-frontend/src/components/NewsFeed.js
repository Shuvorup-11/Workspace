...
import logo from "./assets/twitter-logo-large.png";
...
function NewsFeed() {
  ...
  function handleSignOut(e) {
    ...
    localStorage.removeItem("twitterUserFirstName");
    localStorage.removeItem("twitterUserLastName");
    localStorage.removeItem("twitterUserEmail");
    navigate("/");
  }
