...
function MyProfile() {
  ...
  useEffect(() => {
    ...
    if (localStorage.getItem("twitterUserId") !== null) {
      dispatch(getProfilePosts(localStorage.getItem("twitterUserId")));
      dispatch(getProfileInfo(localStorage.getItem("twitterUserId")));
    }
  }, []);
