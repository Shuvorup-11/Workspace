...
function PostCompose() {
  ...
  const [userFullname, setUserFullname] = useState(
    localStorage.getItem("twitterUserFirstName") +
      " " +
      localStorage.getItem("twitterUserLastName")
  );
  const [userId, setUserId] = useState(localStorage.getItem("twitterUserId"));
  ...
  async function createPost(inputContent) {
    try {
      const response = await axios({
        ...
        headers: {
          Authorization: localStorage.getItem("twitterToken"),
        },
        data: {
          id: null,
          userId: localStorage.getItem("twitterUserId"),
