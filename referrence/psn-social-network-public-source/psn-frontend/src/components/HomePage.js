...
import twitterLogo from "./assets/twitter-logo-large.png";
      ...
      <Row className={styles.container}>
        <Col className={`${styles.colContainerLeft} ${styles.leftBackground}`}>
          <div>
            <Row>
              <h3 className="my-3">
                <BsChatFill /> Welcome to Twitter Clone
              </h3>
            </Row>
          </div>
        </Col>
        <Col className={styles.colContainerRight}>
          <div className={styles.colWithButtons}>
            <img src={"https://www.freeiconspng.com/uploads/cricle-twitter-emblem-png-clipart-8.png"} alt="twitter logo" width={120} className="mb-3" />
            <Row>
              <h1 className={`${styles.textHomePage} mb-3`}>See what is happening in the world right now</h1>
            </Row>
            <br />
            <Row>
              <h3 className={`${styles.textHomePage} mb-3`}>Join twitter clone social network today</h3>
            </Row>{" "}
            <br />
            <Row>
